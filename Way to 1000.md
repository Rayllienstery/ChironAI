...
- [x] **T17.1** Второй язык i18n (ru), возможность переключения в Settings + i18n-lint + workflow · +8 · deps: —
...
**Критерии готовности:**
- [x] tribal knowledge задокументировано (закрывает +10 из +22)
...
**Критерии готовности:**
- [x] мутационное тестирование настроено

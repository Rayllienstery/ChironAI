...
- [ ] **README** — в корне проекта: назначение (Local Coding LLM v0.3), требования (Python, Ollama, Qdrant), установка, запуск краулера и индексации, запуск прокси, настройка Zed; ссылки на TODO.md и CHANGELOG.

...
from config import get_extensions_blocklist_url, get_extensions_local_registry_fallback, get_extensions_registry_url
...
def test_extensions_registry_config_defaults_to_github_with_local_fallback(monkeypatch) -> None:
    ...
    assert get_extensions_blocklist_url() == "extensions/registry/blocklist.json"

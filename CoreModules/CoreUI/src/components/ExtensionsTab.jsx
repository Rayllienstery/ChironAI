...
const EXTENSION_VIEWS = [
  ...
  { id: "dev", label: "Dev Documentation" },
];

function DevDocumentation() {
  return (
...
export default function ExtensionsTab({ onErrorStateChange }) {
  ...
  return (
    <div className="extensions-tab tab-view">
      ...
      {activeView === "dev" ? (
        <section className="app-default-card extensions-view" aria-labelledby="extensions-dev-heading">
          <div className="extensions-view__header">
            <h3 id="extensions-dev-heading">Dev Documentation</h3>
          </div>
          <DevDocumentation />
        </section>
      ) : null}

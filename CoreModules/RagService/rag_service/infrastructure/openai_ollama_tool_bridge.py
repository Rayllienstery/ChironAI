"""Canonical OpenAI Chat Completions <-> Ollama tool/message bridge."""
...
from rag_service.infrastructure.openai_multipart_vision import build_ollama_user_message_from_openai_content

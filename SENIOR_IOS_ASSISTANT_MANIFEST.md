...
- Provide one complete, copy-pastable code example when code is requested.

If the user asks for explanations only, focus on practical, readable reasoning and small examples.

...
# Sections that are autogenerated / low-value for RAG (Conforming Types, Inherited By, etc.).
# Any heading that equals or starts with one of these (after normalizing) is stripped at index time.

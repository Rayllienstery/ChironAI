...
- Transient embed failures: env ``RAG_EMBED_MAX_RETRIES`` (default 0) and ``RAG_EMBED_RETRY_BASE_SEC`` (default 1.0); see ``invoke_embed`` in ``infrastructure/ollama/cli_runner.py``.

...
def split_markdown_into_chunks(
    ...
    Returns list of (chunk_text, section_path). Merges small adjacent chunks in same section.
    """
...
__all__ = [
    "chunk_quality_ok", "split_markdown_into_chunks",
    "CHUNK_MAX_SIZE", "CHUNK_MIN_SIZE", "MIN_CHUNK_WORDS", "MIN_CHUNK_ALPHA_RATIO",
]

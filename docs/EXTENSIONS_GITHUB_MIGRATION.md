...
- [ ] Mutating extension routes require WebUI authentication/authorization. **Deferred to post-beta; see `SECURITY.md` and `README.md` for the current security model.**

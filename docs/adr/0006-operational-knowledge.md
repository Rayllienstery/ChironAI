...
still spread across roadmap notes, local agent memory, CI logs, and individual
...
- **Positive:**
  ...
  - New contributors can diagnose common failures without relying on private
    context.
  - Roadmap tasks can require docs updates when they create or retire a tail.
- **Negative:**
